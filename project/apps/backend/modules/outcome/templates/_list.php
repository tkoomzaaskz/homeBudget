    ...
    <table cellspacing="0">
      <thead>
        <tr>
          ...
          <?php include_partial('outcome/list_th_tabular', array('sort' => $sort)) ?>
        ...
        <tr>
          <th colspan="6">
            <?php if ($pager->haveToPaginate()): ?>
              <?php include_partial('outcome/pagination', array('pager' => $pager)) ?>
            <?php endif; ?>
      ...
      <tbody>
        <?php foreach ($pager->getResults() as $i => $outcome): $odd = fmod(++$i, 2) ? 'odd' : 'even' ?>
        <?php $css = '';
